    ...
    <>
      ...
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-3 space-y-6 xl:col-span-3">
            <Button className="w-10 h-10 float-right rounded-full bg-blue-500 text-white relative flex items-center justify-center cursor-pointer" size="sm" onClick={cartModal.openModal}>
